...
if (isset($_POST["ajouter_au_panier"])) {
    ...
    $prix_article = ($ligne["Prix"] - ($ligne["Prix"] * $ligne["Pourcentage_Solde"])/100);
...
$resultat = mysqli_query($conn, "SELECT * FROM article WHERE type_article = 'katana'");
while ($ligne = mysqli_fetch_assoc($resultat)) 
{
    ...
    echo "<form method='post' action='katana.php'>";
